...
post '/generate' do
  ...
  redirect "/cucumber-html-reports/#{salt}/feature-overview.html"
  rescue => @error
    erb :error
  end
end
...
#release_version = 'cucumber-reporting-0.0.19-SNAPSHOT'
#json_location = 'latest.json'
#output_location = 'latest'
#
#CucumberReporting.new(release_version,json_location,output_location)
